export const YTIcon = () => {
    return(
        <svg className="socialIcons" id="YTIcon" enable-background="new 0 0 24 24" version="1.1" viewBox="0 0 24 24" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <g>
