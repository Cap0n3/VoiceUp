...
const InstaIcon = () => {
	return(
		<svg className="socialIcons" id="InstaIcon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 56.7 56.7" xmlSpace="preserve">
			<g>
