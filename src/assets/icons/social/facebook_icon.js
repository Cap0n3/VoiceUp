...
const FBIcon = ({width}) => {
    return(
        <svg width={width} className="socialIcons" id="FBIcon" version="1.1" viewBox="0 0 56.693 56.693" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
