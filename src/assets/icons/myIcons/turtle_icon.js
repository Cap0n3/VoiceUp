...
const TurtleIcon = ({fill, size}) => {
    return(
        <svg width="35%" height="auto" viewBox="0 0 225 180" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" xmlnsSerif="http://www.serif.com/" fillRule="evenodd">
            <g fill={fill || "#000"}>
