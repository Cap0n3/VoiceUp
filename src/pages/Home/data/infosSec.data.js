...
export const TalkSectionData = {
    ...
    titleEN : "Speaking",
    // Each list element is a <p>
    descriptionFR : ["Notre voix est l’expression de notre personne. Que vous soyez comédien, voix-off ou orateur de profession (avocat, conférencier, manager ou professeur), savoir maîtriser sa voix lorsque vous vous exprimez devant une personne ou un groupe, permet de véhiculer le bon message. Un travail  en profondeur sur le rythme, les accentuations, l’intonation, la hauteur et le volume feront de vous un orateur volubile et charismatique. Apprenez à adapter votre voix selon la situation donnée."],
    descriptionEN : ["Our voice is the expression of our person. Whether you're an actor, voice-over artist, or a professional speaker (lawyer, speaker, manager, or teacher), knowing how to control your voice when expressing yourself to a person or a group enables you to convey the right message. In-depth work on rhythm, accentuation, intonation, pitch, and volume will make you a voluble and charismatic speaker. Learn to adapt your voice to any situations."]
}
