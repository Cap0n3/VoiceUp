...
export const TalkSectionData = {
    ...
    descriptionEN : ["Our voice is the expression of our person. Whether you're an actor, voice-over artist, or a professional speaker (lawyer, speaker, manager, teacher, etc...), knowing how to control your voice when expressing yourself to a person or a group enables you to convey the right message. In-depth work on rhythm, accentuation, intonation, pitch, and volume will make you a voluble and charismatic speaker. Learn to adapt your voice to any situations."]
}
