import ContactHeader from "../../../assets/headers/Header_Contact.jpg";

// HEADER DATA (pic + text)
export const contactHeaderData = {
    picURL: ContactHeader,
    imgTitle: "Contact",
    titleFR: "Contact",
    titleEN: "Contact"
}
...
export const howToCome = {
    titleFR: "Comment venir ?",
    titleEN: "How to get here ?",
    subTitle1FR: "Transports en commun",
