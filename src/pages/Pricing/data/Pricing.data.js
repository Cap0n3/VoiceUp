import WeeklyHeader from "../../../assets/images/stock/PriceHeader3.jpg";
import BiHeader from "../../../assets/images/stock/PriceHeader2.jpg";

export const WeeklyAdult = {
    headerImage: WeeklyHeader,
    animIcon: "rocket",
    bckColors: ["#c96881", "#f7b695"],
    cardNameFR: "Hebdomadaire Adulte",
